...
urlpatterns = patterns('',
                        ...
                        #TrainingViews
                        url(r'^incul/kanji/quizze/(?P<answer>\w*)[/]?$', 'note.trainingsViews.kanjiQuizze', name='kanjiQuizze'),
                        url(r'^incul/bunpou/training/dictionary/$', 'note.trainingsViews.dictionary', name='dictionaryTraining'),
